...
# training_args.val_datapath = '../../wiki_test/wiki.valid.raw'
# training_args.train_datapath = '../../wiki_test/wiki.train.raw'

training_args.val_datapath = '../../validation_SABIC_short.txt'
training_args.train_datapath = '../../train_SABIC_short.txt'
